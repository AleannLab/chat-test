...
const InputBox = (
  ...
  useEffect(() => {
    ...
    const variableBuilder = new VariableBuilder(BASE_VARIABLES);
    variableBuilder.add('firstname', selectedPatient?.firstname);
    variableBuilder.add('lastname', selectedPatient?.lastname);
    variableBuilder.add('phone', selectedPatient?.phone_no);
    variableBuilder.add('officename', officeProfile?.data?.office_name);
    variableBuilder.add('oslink', getOsLink());
    setVariables(variableBuilder.getVariables());
  }, [patientsFeed.selectedPatient, officeProfile?.data]);
