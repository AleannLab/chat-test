...
export class PaperlessForm extends Resource {
  ...
  @observable formAdditionSuccessful = false;
  @observable formAdditionUnsuccessful = false;
  @observable selectedFormForPreview = {
  ...
  @observable groupedSections = new Map();
  @observable temporarySections = [];
  @observable emptyGroup = false;
  @observable emptySection = false;
  @observable sectionToGroupAdditionSuccessful = false;
  @observable sectionToGroupAdditionUnsuccessful = false;
  @observable isSectionArchived = false;
  @observable isSectionUnarchived;
  @observable isSectionRemovedFromGroup;
  @observable sectionsToAddToGroups = [];
  @observable filledOutCount = '-';
  @observable isGroupSent = false;
  @observable printingData = {};
  ...
  // Invitation data
  @observable patientsInvitationList = [];

  @observable searchItem = '';
  @observable metaOnly = false;
  @observable generatingPdf = false;
  @observable generatedPdfUrl = '';
