...
export default class RadioComponent extends Field {
  ...
  render() {
    return (
      <>
        <button onClick={this.handleClickOpen}>view list</button>
        {/* <Button
          variant="contained"
          size="large"
          color="secondary"
        ...
        <div open={this.state.open} onClick={this.handleClose}>
          {/* <IconButton size="small" style={{position:"absolute",float:"right"}} color="secondary" onClick={onClose}>
            <CloseIcon />
      </IconButton> */}
          {super.render(
