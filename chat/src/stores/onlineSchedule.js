...
export class OnlineSchedule extends Resource {
  ...
  @observable practitionerData = {
    practitionerIds: [],
    selectedPractitioner: {},
  };
  @observable appointmentConfig = {
    selectedAppointment: {
      available_for: '',
      id: null,
      label: null,
  ...
  @observable patientType = 'New';
  @observable scheduleNow = false;
  @observable vacations = [];
  @observable practitionerBusyDays = {};
  @observable practitionerBusyDaysCopy = {};
  @observable slots = [];
  @observable slotsCopy = [];
  @observable disable = false;
  @observable timeExpired = false;
  @observable anyProvider = false;
