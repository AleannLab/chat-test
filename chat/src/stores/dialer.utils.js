...
export class Dialer extends Resource {
  ...
  @observable error;
  @observable isMicrophoneAllowed = true;

  @observable isDialerExpanded = false;

  @observable destination;

  @observable callLines = [];
  @observable activeCallLineNumber = -1;

  @observable remoteStream;
  ...
  @observable dialCallStore = new AsyncStore();
...
class CallLine extends Resource {
  @observable isInboundCall = false;
  @observable callStatus = CALL_STATUS.INITIAL;
  @observable call;
  @observable timer;
  @observable lineNum;
  @observable remoteStream;
  ...
  @observable isHeld;
  @observable isMute;
  @observable isDialing;

  @observable telnyxCallControlId;
  @observable fromSipUserName;

  intervalHandler = null;
  @observable duration = 0;

  @observable showTransferDialPad = false;
  ...
  @observable holdCallStore = new AsyncStore();
  ...
  @observable transferStore = new AsyncStore();
  ...
  @observable getCallStore = new AsyncStore();
